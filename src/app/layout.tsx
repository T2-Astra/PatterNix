...
export const metadata: Metadata = {
  ...
  title: "PatterNix - Background Patterns & Gradients Snippets",
  description:
  ...
  authors: [{ name: "Krish Mhatre", url: "https://github.com/T2-Astra" }],
  creator: "Krish Mhatre",
  publisher: "PatterNix",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "PatterNix – Modern Background Patterns and Gradients Snippets",
      },
    ],
  },
  twitter: {
    ...
    creator: "@KrishMhatr14800",
    site: "@KrishMhatr14800",
  },
  alternates: {
  ...
  applicationName: "PatterNix",

  // Schema.org structured data hints
  other: {
    "application-name": "PatterNix",
    "mobile-web-app-capable": "yes",
    "apple-mobile-web-app-capable": "yes",
    "apple-mobile-web-app-status-bar-style": "default",
    "apple-mobile-web-app-title": "PatterNix",
    ...
    // Rich snippets hints
    "article:author": "Krish Mhatre",
    "article:publisher": "https://github.com/T2-Astra",
    ...
    distribution: "global",
    rating: "general",
    copyright: "© 2025 Krish Mhatre. All rights reserved.",
  },
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebSite",
              name: "PatterNix",
              url: "https://github.com/T2-Astra/PatterNix",
            }),
          }}
        />
