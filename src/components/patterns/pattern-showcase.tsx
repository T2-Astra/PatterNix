                ...
                className={`
                  ...
                  ${
                    activeTab === category.id
                      ...
                      : "bg-white/70 text-gray-700 border-gray-200/40 hover:bg-white/90 hover:text-gray-900 hover:border-gray-300/50"
                  }
                `}
              >
            ...
            <div className="mb-6">
              <p
                className={`text-sm transition-colors duration-300 ${
                  isPatternDark ? "text-gray-200" : "text-muted-foreground"
                }`}
              >
