...
export const gridPatterns: Pattern[] = [
  ...
  // Dark Fade Grid Patterns
  {
    id: "dark-top-fade-grid",
    name: "Dark Top Fade Grid",
    category: "geometric",
    badge: "New",
    style: {
      background: "#0f172a",
  ...
  {
    id: "dark-bottom-fade-grid",
    name: "Dark Bottom Fade Grid",
    category: "geometric",
    badge: "New",
    style: {
      background: "#0f172a",
    ...
    code: `<div className="min-h-screen w-full bg-[#0f172a] relative">
  {/* Dark Bottom Fade Grid Background */}
  <div
    className="absolute inset-0 z-0"
    style={{
      backgroundImage: \`
  ...
  {
    id: "dark-diagonal-fade-grid-left",
    name: "Dark Diagonal Fade Grid Left",
    category: "geometric",
    badge: "New",
    style: {
      background: "#111827",
  ...
  {/* Dark Diagonal Fade Grid Background - Top Left */}
  <div
    className="absolute inset-0 z-0"
    style={{
      backgroundImage: \`
  ...
  {
    id: "dark-diagonal-fade-grid-right",
    name: "Dark Diagonal Fade Grid Right",
    category: "geometric",
    badge: "New",
    style: {
      background: "#111827",
    ...
    code: `<div className="min-h-screen w-full bg-[#111827] relative">
  {/* Dark Diagonal Fade Grid Background - Top Right */}
  <div
    className="absolute inset-0 z-0"
    style={{
      backgroundImage: \`
